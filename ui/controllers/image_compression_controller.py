...
SUPPORTED_COMPRESSION_EXTS: Set[str] = {
    ".jpg",
    ".jpeg",
    ".png",
    ".webp",
...
class CompressionController:
    """Controller managing single-file and batch directory compression business logic."""

    def __init__(self) -> None:
        """Initializes state variables for compression execution and safety guards."""
    ...
    def _execute_single_file(
        ...
        """Executes single-file compression flow and displays summary dialog."""
