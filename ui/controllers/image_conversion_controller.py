...
class ConversionController:
    """Controller managing single-file and batch directory conversion business logic."""
    ...
    def execute_conversion(
        ...
        if self.selected_input.is_file():
            self._execute_single_file(
                page, target_format, selected_color_key, lbl_status
            )
        else:
            self._execute_batch_directory(
                page,
                target_format,
                selected_color_key,
                lbl_status,
